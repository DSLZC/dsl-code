package cn.dslcode.common.function;

import cn.dslcode.common.core.collection.CollectionUtil;
import cn.dslcode.common.core.function.bigdecimal.BigDecimalSummaryStatistics;
import cn.dslcode.common.core.function.stream.CollectorsDefined;
...
public class TestBigDecimalSummary {
    ...
    public static void main(String[] xxx){
        List<Goods> goodses = CollectionUtil.getList(
